...
DP.Emotes = {
   ...
   ["fspose"] = {"missfam5_yoga", "c2_pose", "F Yoga Pose", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
   ...
   ["fspose2"] = {"missfam5_yoga", "c6_pose", "F Yoga Pose 2", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
   ...
   ["fspose4"] = {"anim@amb@carmeet@checkout_car@", "female_c_idle_d", "F Yoga Pose 4", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
...
DP.PropEmotes = {
   ...
   ["drink"] = {"mp_player_intdrink", "loop_bottle", "Drinking Water", AnimationOptions =
   {
   ...
   ["drink2"] = {"mp_player_intdrink", "loop_bottle", "Drinking Soda", AnimationOptions =
   {
        Prop = 'prop_ecola_can',
        PropBone = 18905,
        PropPlacement = {0.12, 0.008, 0.03, 240.0, -60.0},
   ...
   ["drink3"] = {"mp_player_intdrink", "loop_bottle", "Drinking Whisky", AnimationOptions =
   {
        Prop = 'ba_prop_battle_whiskey_bottle_2_s',
        PropBone = 18905,
        PropPlacement = {0.12, 0.008, 0.03, 240.0, -60.0},
   ...
   ["drink4"] = {"mp_player_intdrink", "loop_bottle", "Drinking  Beer", AnimationOptions =
   {
        Prop = 'prop_amb_beer_bottle',
        PropBone = 18905,
        PropPlacement = {0.12, 0.008, 0.03, 240.0, -60.0},
   ...
   ["drink5"] = {"mp_player_intdrink", "loop_bottle", "Drinking  Coffee", AnimationOptions =
   {
      Prop = 'p_amb_coffeecup_01',
        PropBone = 18905,
        PropPlacement = {0.12, 0.008, 0.03, 240.0, -60.0},
